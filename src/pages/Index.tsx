    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-24 md:pt-32 pb-16 md:pb-20">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h1 className="font-serif text-4xl md:text-6xl font-bold text-foreground mb-6 leading-tight">
              Discover the Healing <br className="hidden md:block" />
              Power of <span className="text-primary">Nature</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed max-w-2xl mx-auto">
              Explore traditional AYUSH medicinal plants, learn their healing properties, and connect with ancient wisdom for modern wellness.
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/search">
                <Button size="lg" className="w-full sm:w-auto gap-2">
                  <Search className="w-5 h-5" /> Explore Plants
                </Button>
              </Link>
              <Link to="/map">
                <Button size="lg" variant="outline" className="w-full sm:w-auto gap-2">
                  <MapPin className="w-5 h-5" /> View Garden
                </Button>
              </Link>
            </div>
          </motion.div>
      ...
      <section className="py-16 md:py-20 bg-primary">
        <div className="container mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <Link to="/add-post">
              <Button size="lg" className="bg-accent text-accent-foreground hover:bg-accent/90 gap-2">
                <Leaf className="w-5 h-5" /> Add Your Post
              </Button>
            </Link>
          </motion.div>
        </div>
      ...
      <footer className="py-8 bg-card border-t border-border mb-16 md:mb-0">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-sm text-muted-foreground">© 2024 AYUSH Virtual Herbal Garden. Educational purposes only.</p>
        </div>
      </footer>
